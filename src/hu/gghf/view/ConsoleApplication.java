...
public class ConsoleApplication implements GameEventListener {
        ...
        if (parts[0].equals("loadmap")) {
            ...
            if (map != null && parts.length > 2) {
                ...
                if (parts[1].equals("0") || parts[1].equals("1")) {
                    ...
                    if (p == null) {
                        GameEventHandler.printCall("A replikator nem letezek");
                        return;
                    }
                    switch (dir) {
                        case "up":
    ...
    class ReplicatorThread extends Thread {
        ...
        public ReplicatorThread(ConsoleApplication application) {
        ...
        public void run() {
            while (!stopped) {
                if (app != null && !ConsoleApplication.test) {
